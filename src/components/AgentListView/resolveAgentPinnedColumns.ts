...
export const DEFAULT_AGENT_PINNED_COLUMNS: PinnedColumns = {
  left: ["name"],
  right: ["actions"],
};
...
/** Maps consumer-friendly pin ids (`action`) to table column ids and drops unknown columns. */
export function resolveAgentPinnedColumns(
  pinnedColumns: PinnedColumns | undefined,
  columnIds: string[],
): PinnedColumns | undefined {
  const source = pinnedColumns ?? DEFAULT_AGENT_PINNED_COLUMNS;
